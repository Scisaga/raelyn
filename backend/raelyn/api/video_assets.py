    ...
    with session_scope() as session:
        ...
        for a in assets:
            ...
            if download:
                ...
                response_cd = content_disposition_attachment(filename)
            ref = build_asset_ref(a, filename=filename, response_content_disposition=response_cd) if presign else None
            out.append(
                VideoAssetOut(
                    id=a.id,
                    type=a.type,
                    ...
                    download_presigned_url=ref.download_presigned_url if ref else None,
                    filename=filename,
                )
            )
        return out

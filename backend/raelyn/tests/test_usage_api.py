...
class UsageServiceTests(_UsageFixture, unittest.TestCase):
    ...
    def test_payload_uses_shanghai_days_and_preserves_unsampled_nulls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["external_calls"], 3)
        self.assertEqual(payload["summary"]["llm_calls"], 2)
        self.assertEqual(payload["summary"]["asr_calls"], 1)
        self.assertIsNone(payload["summary"]["embedding_calls"])
        self.assertIsNone(payload["summary"]["llm_input_tokens"])
        self.assertIsNone(payload["summary"]["llm_output_tokens"])
        ...
        self.assertIsNone(by_date["2026-09-03"]["llm_total_tokens"])
